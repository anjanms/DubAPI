...
function EventHandler(message, env, channel) {
    ...
    case events.chatMessage:
        ...
        this._.room.chat.add(utils.clone(message, true));
        break;
    ...
    case events.roomPlaylistUpdate:
        ...
        this._.room.playTimeout = setTimeout(this._fetchMedia.bind(this), this._.room.play.getTimeRemaining() + 15000);
    ...
    if (Object.keys(events).some(function(event) {return message.type === event;})) {
        ...
        if (message.song instanceof MediaModel) message.song = utils.clone(message.song);
    }
